    ...
    layui.use(['table','layer', 'form', 'jquery','flow'],function () {
        ...
        flow.load({
            ...
            ,done: function(page, next){ //到达临界点（默认滚动触发），触发下一页
                ...
                $.get('/main/getNotice?page='+page, function(res){

                    //假设你的列表返回在data集合中
                    layui.each(res.data, function(index, item){

                        lis.push('<a href="/main/lookNotice?id='+ (item.id) +' " style="width:100%;height:220px;"><div class="top"><h5>'+ item.title +'</h5><div class="p"><p>'+ item.author +'</p></div>\n' +
                            '<img src="/images/new-jiantou.jpg"></div><div class="bottom"><h3>'+item.releasedate +'</h3></div></a>');
