...
<div class="layui-layout layui-layout-admin">
    ...
    <ul class="layui-nav layui-layout-left">
        ...
        <a href="main/homePage" target="middle"><i class="layui-icon" data-icon="&#xe68e;">&#xe68e;&nbsp;&nbsp;</i><cite>主页</cite></a>
        </li>
...
<%--                    <img src="http://t.cn/RCzsdCq" class="layui-nav-img">--%>
                    <img src="/images/320755dbe6849f1c26308e67c5eb2b67.jpeg" class="layui-nav-img">
                    ${sessionScope.login_user.username}
                </a>
                <dl class="layui-nav-child">
                    <%--   target="middle"在指定的框架中打开被链接文档。 --%>
                    <dd><a href="easUser/basicInformationIndex" target="middle">基本资料</a></dd>
                    <dd><a href="easUser/passwordRestIndex" target="middle">修改密码</a></dd>
                </dl>
            </li>
                        ...
                        <li class="layui-nav-item layui-nav-itemed">
                            ...
                            <dl class="layui-nav-child">
                                <c:forEach items="${sessionScope.user_pers}" var="child">
                                    ...
                                    <dd><a href="${child.url}" target="middle">${child.text}</a></dd>
                                    </c:if>
                                </c:forEach>
                            </dl>
                        </li>
    ...
    <div class="layui-body">
        <iframe src="main/homePage" name="middle" width="100%" height="100%" frameborder="0"></iframe>
    </div>
