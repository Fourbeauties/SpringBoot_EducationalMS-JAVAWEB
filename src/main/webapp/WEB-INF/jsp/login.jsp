...
<head>
    ...
    <script>
        ...
        function reloadValidateCode(){
            $("#validateCodeImg").attr("src","/validatecode.jsp?data=" + new Date() + Math.floor(Math.random()*24));
        }
...
<div class="layui-container">
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form id="login" class="layui-form" action="/easLogin/login" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img   id="validateCodeImg"  src="/validatecode.jsp" onclick="reloadValidateCode()">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    ...
    function registerForm() {
        $.get("/easRegister/registerForm",function (str) {
            var resisterIndex = layer.open({
                ...
                yes : function (index) {
                    ...
                    $.post('/easRegister/registerUser',params2,function (data) {
