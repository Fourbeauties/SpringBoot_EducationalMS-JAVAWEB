...
<script>
    ...
    $.get('/easPermission/parentList',function (zNodes) {
    ...
    layui.use('table',function () {
        ...
        table.on("radio(roleTable)",function (obj) {
            ...
            $.post('/easRole/rolePers',{id:obj.data.id},function (data) {
                //先获取所有的根节点
        ...
        table.on('toolbar(roleTable)',function (obj) {
            ...
            switch (e){
                case "add":
                    $.get('/easRole/roleForm',function (str) {
                        layer.open({
                            type:1,
                            title :'添加角色',
                            area : '700px',
                            ...
                            yes : function (index) {
                                ...
                                $.post('/easRole/addRole',params,function (data) {
                ...
                case "batchDelete":
                    ...
                    layer.confirm('真的干掉这么多基本课程吗？',{icon:5,title:'友情提示'},function (index) {
                        ...
                        $.post('/easRole/batchDeleteRole',params,function (data) {
                            if(data.code==1){
                                layui.layer.msg(data.msg,{icon:5})
                            }else{
            ...
            if (obj.event == 'edit'){ //edit
                $.get("/easRole/roleForm",function (str) {
                    layer.open({
                        ...
                        btn:['确定','取消'],
                        success:function(){
                            $.get('/easRole/getRoleView',{id:data.id},function (data) {
                                //显示数据
                        ...
                        yes : function (index) {
                            ...
                            $.post('/easRole/editRole',params2,function () {
                                layer.close(index);
                ...
                layer.open({
                    ...
                    btn:['确定','取消'],
                    yes : function () {
                        $.post("/easRole/batchDeleteRole",{"ids":data.id},function (data) {
                            if(data.code==0){
