...
<script>
    ...
    layui.use(["table","form"],function(){
        ...
        table.on('toolbar(baseCourseTable)',function (obj) {
            ...
            switch (e){
                case "add":
                    $.get('/easBaseCourse/baseCourseAddForm',function (str) {
                        layer.open({
                            type:1,
                            title :'添加基本课程',
                            area : '700px',
                            ...
                            yes : function (index) {
                                ...
                                $.post('/easBaseCourse/addBaseCourse',params,function (data) {
                ...
                case "batchDelete":
                    ...
                    layer.confirm('真的干掉这么多基本课程吗？',{icon:5,title:'友情提示'},function (index) {
                        ...
                        $.post('/easBaseCourse/batchDeleteBaseCourse',params,function (data) {
            ...
            if (obj.event == 'edit'){ //edit
                $.get("/easBaseCourse/baseCourseAddForm",function (str) {
                    layer.open({
                        ...
                        btn:['确定','取消'],
                        success:function(){
                            $.get('/easBaseCourse/getBaseCourseView',{id:data.id},function (data) {
                                //显示数据
                        ...
                        yes : function (index) {
                            ...
                            $.post('/easBaseCourse/editBaseCourse',params2,function (data) {
                                layer.close(index);
                                console.log(data);
                               if(data.code==1){
                ...
                layer.open({
                    ...
                    btn:['确定','取消'],
                    yes : function () {
                        $.post("/easBaseCourse/batchDeleteBaseCourse",{"ids":data.id},function () {
