...
<script>
    ...
    layui.use(['table','form'],function(){
        ...
        table.render({
            ...
            ,url:'/easCourse/getCourseList' //获取数据
            ,even: true
        ...
        table.on('toolbar(adminCourseTable)',function (obj) {
            ...
            switch (e){
                case "add":
                    ...
                    $.get('/easCourse/courseAddForm',function (str) {
                        var addCourseIndex =layer.open({
                            ...
                            yes : function (index) {
                                ...
                                $.post('/easCourse/addCourse',params,function (data) {
                ...
                case "batchDelete":
                    ...
                    layer.confirm('真的干掉这么多数码吗？',{icon:5,title:'友情提示'},function (index) {
                        ...
                        $.post('/easCourse/batchDeleteCourse',params,function (data) {
                            if (data.code ==0 ){
        ...
        table.on("tool(adminCourseTable)",function (obj) {
            ...
            if (obj.event == 'edit'){ //edit
                $.get("/easCourse/courseEditForm",function (str) {
                    var editCourseIndex = layer.open({
                        ...
                        anim: 1, //从上掉落样式
                        success:function(){
                            $.get('/easCourse/getCourseById',{id:data.id},function (data) {
                        ...
                        yes : function (index) {
                            ...
                            $.post('/easCourse/editCourse',params2,function (data) {
                ...
                layer.open({
                    ...
                    btn:['确定','取消'],
                    yes : function () {
                        $.post("/easCourse/batchDeleteCourse",{"ids":data.id},function (data) {
                            if (data.code ==0 ){
                                layer.msg('删除成功');
                                table.reload('adminCourseTable');
                            }else{
