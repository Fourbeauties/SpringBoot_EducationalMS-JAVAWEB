...
<body>
<form class="layui-form" action="easUser/basicInformationIndex"  style="padding-left: 100px;padding-top: 50px;">
...
<script>
    ...
    function editForm() {
        $.get("easUser/basicForm",function (str) {
            layer.open({
                type:1,
                title :'修改基本资料',
                area : '700px',
                ...
                btn : ['修改','取消'],
                success : function () {
                    $.get('/easUser/getBasicInformation',function (data) {
                        //显示数据
                        //修改基本资料时 班级无法获取
                ...
                yes:function (index){
                    ...
                    $.post('/easUser/modifyInformation',params2,function (data) {
                        // console.log(params2);
                        if(data.code == 0){
                            layer.close(index);
