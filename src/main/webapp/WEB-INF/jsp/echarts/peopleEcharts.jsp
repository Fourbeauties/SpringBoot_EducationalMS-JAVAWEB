...
<script>
    layui.use(["table","form","laytpl"],function() {
        var table = layui.table,
            ...
            $.get('/easEchart/getAllStuAndTea').done(function (res) {
                console.log("返回的数据为:"+res.totalStu);
                ...
                mySAndTChart.setOption({
                    ...
                    series: [{
                        ...
                        data: [
                            {value: res.totalTeaN, name: '教师人数'},
                            {value: res.totalStuN, name: '学生人数'}
                            // {value: 50, name: ''},
                            // {value: 100, name: ''}
                        ],
                        emphasis: {
        ...
        $.get('/easEchart/getAllSex').done(function (data) {
